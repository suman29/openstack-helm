{
    ...
    "context_is_admin": "rule:context_is_key_admin",
    "service_user": "role:service",
    "owner": "project_id:%(project_id)s",
    "member": "role:member and rule:owner",
    "viewer": "role:keymanager_viewer and rule:owner",
    "key_admin": "role:keymanager_admin and rule:owner",
    "context_is_key_admin": "rule:context_is_admin or rule:context_is_key_admin",
